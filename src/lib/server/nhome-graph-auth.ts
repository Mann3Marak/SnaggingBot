// Microsoft Graph *application* token (client-credentials) used by the Outlook
// bookings sync. Self-contained: only needs MS_TENANT_ID / MS_CLIENT_ID /
// MS_CLIENT_SECRET (with NEXT_PUBLIC_* fallbacks) and Calendars.ReadWrite consent.
